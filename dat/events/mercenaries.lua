...
function spawn_merc(source)
   ...
   local names = {
      Llama = N_("Mercenary Llama"),
      Hyena = N_("Mercenary Hyena"),
      Shark = N_("Mercenary Shark"),
      Lancelot = N_("Mercenary Lancelot"),
      Vendetta = N_("Mercenary Vendetta"),
      ...
      Kestrel = N_("Mercenary Kestrel"),
      Hawking = N_("Mercenary Hawking"),
   }
   local fleet_choices = {
...
function choose_target()
   ...
   if hire_faction:playerStanding() < 0 and rnd.rnd() < 0.05 then
      return player.pilot()
   end
