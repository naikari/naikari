...
local sos_msg = {
   ...
   _("This is {pilot}. If you get this message, please assist. I'm in distress. Comm is not responding. I've no nav control. Please assist."),
   _("This is {pilot} urgently requestig rescue. All systems down. If you get this message, please assist."),
