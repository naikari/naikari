...
pay_text = _([[You deliver the parcels to the Empire Shipping station at the {planet} spaceport. Afterwards, they make you do some paperwork to formalise your participation with the Empire. They tell you to keep an eye out in the mission computer for missions labeled ES, which stands for Empire Shipping, to which you now have access. You can go to the mission computer by clicking on the Missions tab.
