...
"My mother once told me that chaos is like a hurricane. Most people get stuck in the thick of it, but there's always a small group of people in the eye of chaos: people who can't see the deadly winds circling around them. It makes them complacent. The Empire has been in the eye of chaos for so long, it's like they didn't even realize the storm was looming in the first place, and now it's hitting them all at once."]])
...
finish_text = _([[You locate Commander Soldner and deliver the news to him. He listens patiently and nods when you finish. "I see. That's an unfortunate outcome, but thru no fault of your own. You've done a great job out there, {player}. Earning the trust of a Dvaered is no easy feat, and it sounds like you may have earned Lensa's trust, but it seems that just won't be enough to get the warlords involved.
