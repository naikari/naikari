...
Having heard everything he's said so far, you suddenly find yourself interested in the FLF. You take the initiative for the first time on this journey and ask Flint if he would be willing to show you that fighting spirit. An image of surprised happiness briefly appears on his face before he shifts into a grin. "So you finally get it. I guess this trip wasn't a waste after all. Very well!
...
norpin_text[2] = _([[The two of you begin approaching the bar. "You may have heard rumors that the shipyard here supplies ships for us," Flint says. "That's actually true, but this shipyard also supplies ships for the Frontier volunteer peacekeeping force. That's actually another reason the Dvaereds put Raglan Outpost where they did. It's a choke point; right now, it makes it much harder for FLF ships to be supplied by this shipyard, which is why we also build ships on Sindbad. If the Dvaereds go to war with the Frontier officially, that will be the case for Frontier ships as well.
...
norpin_text[3] = _([[As if on cue, a group of three of visibly angry patrons steps up behind the Dvaered soldiers. "It seems we have ourselves a problem here," one of them says as the bartender turns to look away from the scene.
...
norpin_text[5] = _([[The FLF group immediately responds by drawing their own laser guns and before you know it, a gunfight ensues. Someone from the FLF side is hit first, taking a bolt to the leg, followed by one of the Dvaereds getting hit in the stomache, knocking him out. You immediately see a difference between the two sides as while Flint helps his now limping comrade escape while the other two continue drawing attention from the uninjured Dvaered, the uninjured Dvaered seems entirely uninterested in helping his own fallen comrade, clearly more interested in shooting the remainder of the FLF group.

Flint and his injured comrade soon escape the scene, and the other two in the FLF group run off in a different direction shortly after. Seeing this, the uninjured Dvaered pursues them, leaving his comrade lying on the ground.
