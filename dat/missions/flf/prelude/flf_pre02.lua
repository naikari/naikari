...
answer_text = {}
answer_text.help = _([[You tell the man that you have heard of the struggles of the FLF and want to help fight the Dvaered. The main frowns. "OK, first of all, who the hell do you think you are? Do you think you, an outsider who doesn't even understand the struggles of the Frontier, are goïng to be our savior? Why are you people always so damn full of yourselves?!" Unsure of what to say, your eyes shift from his gaze to the floor below you. Despite this, you can feel his eyes on you as strongly as ever.

"Let's get one thing straight: you're not goïng to be the one to fly in and cure all our problems any more than you're goïng to fly in and destroy us. We've been working hard to save the Frontier for a long time now. If you have any part at all in this, it will be on the back of the many of us who have worked on this project all this time, and who actually have a stake in it."

He sighs once again, then stands up. "That said, if you really do want to help, you need to understand our struggles properly. So I'll tell you what: I'm about to go on some errands in a couple hours, and I'm willing to take you with me. Well? Will you still help, knowing that it's not goïng to be the ridiculous action fantasy you believe in?"]])
...
response_yes = {}
response_yes.help = _([[The man grins. "Perfect. Maybe I can get you to chuck that shitty pretentiousness of yours out the window and show you what the FLF is really about. We'll first be goïng to my homeworld, {planet}, to help out on the algae farm. So yeah, not the exciting combat I'm sure a mercenary type like you was expecting.
...
response_yes.neutral = _([["Good. Let's nip that shitty perception you have of what we're about in the bud. We'll first be goïng to my homeworld, {planet}, to help out on the algae farm. Yeah, not exactly the violence you expect from us based on the distorted picture the Dvaereds give you, eh?

"The name's Flint, by the way. Flint as in if you try to turn me over to the Dvaereds, I'll light a fire in your ass." As the FLF soldiers around you chuckle at Flint's remark, you tell Flint your own name, then promise that you won't double-cross him. "Good. I'll meet you at the landing bay. I would fly my own ship, but you beïng neutral means that we can avoid detection from the Dvaereds and make better time. Besides, I don't trust you to have my back. At least if I'm on your ship, I can kill you and steal the ship, eh?" You let out a nervous laugh as he turns and walks toward the direction of the landing bay. You begin to wonder just what this so-called "algae farm" is about. You thought the FLF was just a military group, but you decide to keep an open mind.]])
response_yes.learn = _([["Alright, then. I'm sure this'll be the learning experience you were looking for. Don't you forget, though, I'm doïng you a favor. Our destination is my homeworld, {planet}. I'll let you do the flying.
...
Nervous, you express concern with beïng out in the open as a part of the FLF. Flint facepalms in response. "God damn, it's like Dvaered propaganda has a direct connection to your brain. Why the hell would you think we'd get anything other than a warm reception as a part of the FLF?"]])
...
Flint and his injured comrade soon escape the scene, and the others in the FLF group run off in a different direction shortly after. Seeïng this, the uninjured Dvaered pursues them, leaving his comrade lying on the ground.
...
misn_desc = {}
misn_desc.help = _([[You angered an FLF soldier called Flint when you told him that you seek to help the Frontier. In response, he offered to "show you personally what's goïng on in the Frontier". He said that he hopes to "get you to chuck that shitty pretentiousness of yours out the window".]])
misn_desc.neutral = _([[You angered an FLF soldier called Flint when you told him that you're neutral in the conflict between the FLF and House Dvaered. In response, he offered to show you what's goïng on in the Frontier. He said that you will "see soon why beïng neutral in this conflict is unacceptable".]])
