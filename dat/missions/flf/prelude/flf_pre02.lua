...
response_yes.learn = _([["Alright, then. I'm sure this'll be the learning experience you were looking for. Don't you forget, thô, I'm doing you a favor. Our destination is my homeworld, {planet}. I'll let you do the flying.
...
jorlan_text.learn[4] = _([[Flint grins. "Our fighting spirit won't flounder, thô. One of these days, that damn station will be gone, and we'll drive out the Dvaereds once and for all." Flint looks at you as he continues speaking. "You know what, you've been helpful enough that I'm willing to show you that fighting spirit. Take us to {planet} as our last destination. There's nothing we need to do there in particular, but I trust you just enough to introduce you to some of my comrades."]])
