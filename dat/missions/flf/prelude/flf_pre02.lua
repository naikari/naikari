...
homeworld_text.help[2] = _([[A brief pause passes, and you stammer out an apology. Flint sighs. "This is the problem with Imperials like you. Always thinking you know everything when you know absolutely nothing." An awkward silence fills your cockpit as you land your ship.
...
homeworld_text.neutral[2] = _([[Unsure of what else to say, you stammer out an apology for your callousness. Flint sighs. "See, this is the problem with you. You approach our oppression like some sort of damn curiosity and not as horrible human suffering. Do you not care about us at all?" An awkward pause follows where you're not sure what to say.
...
homeworld_text.neutral[4] = _([[Eventually, Flint finishes introducing you to people. He turns to you as you and he walk back toward the spaceport. "Hopefully you'll have an inkling of what's at stake here now," he says. You apologize for minimizing the situation, and he silently turns his head to face the direction he's walking in again.
...
One story stands out to you in particular: an adolescent, no older than maybe 10 cycles, mentions their mother who was an official Frontier peace-keeping volunteer. She was accused of being an FLF pilot after getting into an argument with a Dvaered pilot who was harassing a civilian, and during the argument, the Dvaered opened fire and killed her.]])
homeworld_text.learn[3] = _([[Eventually, Flint finishes introducing you to people. He turns to you as you and he walk back toward the spaceport. You thank Flint for helping you properly understand some of the struggles of the Frontier, and he raises his eyebrows in surprise again. "Oh! Uh, you're welcome," he says.
...
jorlan_text.neutral[4] = _([[Flint looks toward you. "The one thing stopping the Dvaereds from successfully invading the Frontier is the thing they didn't count on: our fighting spirit. Sindbad may be the brains of the FLF, but those of us who work on the ground are the blood, muscle, and heart of the FLF!"
...
jorlan_text.learn[4] = _([[Flint grins. "But there's one thing the Dvaereds didn't count on, one thing stopping them from successfully invading the Frontier: our fighting spirit! Our final stop will be {planet}. Feel free to take a look around here if you like. When you're ready, I'll show you the strength of our undying commitment to fight the Dvaereds! The higher-ups of Sindbad may be the brains of the FLF, but the people on the ground are the blood, muscle, and heart of the FLF."]])
