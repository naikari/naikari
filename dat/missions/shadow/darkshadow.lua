...
explain_text = _([[You make your way through the now familiar corridors of the Seiryuu. You barely notice the strange environment anymore. It seems unimportant compared to the strange events that surround your every encounter with these Four Winds.
...
objective_text = _([["It is my belief that one or more of my fellow captains have abandoned their mission, and are misusing their resources for a different agenda. I have been unable to find out the details of Four Winds missions that I did not command myself, which is a bad sign. I am beïng stonewalled, and I don't like it. I want to know what's goïng on, {player}, and you're goïng to help me do it.
...
You and Jorek sit down at the holotable in the middle of the bridge and report on the events surrounding Jorek's retrieval. When you're done, Captain Rebina calls up a schematic view of the Genbu from the holotable. "It would seem that Giornio and his comrades have a vested interest in keeping me away from the truth. It's a good thing you managed to get out of that ambush and bring me that informant. I do hope he'll be able to shed more light on the situation. I've got a bad premonition, a hunch that we're goïng to have to act soon if we're goïng to avert disaster, whatever that may be. I trust that you will be willing to aid us again when that time comes, {player}. We're goïng to need all the help we can get. For now, you will find a generous amount of credits in your account. I will be in touch when things are clearer."
...
"It is my belief that one or more of my fellow captains have abandoned their mission, and are misusing their resources for a different agenda. I have been unable to find out the details of Four Winds missions that I did not command myself, which is a bad sign. I am beïng stonewalled, and I don't like it."]])

log_text_succeed = _([[You found Jorek and successfully retrieved his informant on behalf of Captain Rebina. The Genbu ambushed you, but you managed to get away and dock the Seiryuu. Captain Rebina remarked on the situation. "I've got a bad premonition, a hunch that we're goïng to have to act soon if we're goïng to avert disaster, whatever that may be. I trust that you will be willing to aid us again when that time comes, {player}. We're goïng to need all the help we can get. For now, you will find a modest amount of credits in your account. I will be in touch when things are clearer."
