...
disable_text = _([[After managing to bypass the ship's security system, you enter the cockpit and notice that the fighter has been sabotaged and might soon explode. You head to the living cabin. As you cross the access hatch, you see him on his knees coughing painfully. As he looks up at you, you find yourself horrified by the awful mask of pain on his face. His bulging, bloodshot eyes stare at you, as if they wanted to pierce your skin. A repugnant creamy fluid ejects from his mouth as he starts to speak in a groan. "Good job out there. But, you see? You won't catch me alive. The pill of silence will make sure of that. It looks painful, doesn't it? You know what? It's even worse than it looks. I guarantee it."

You approach the man and ask him why he killed the diplomats. "You have no idea what's going on, do you? I'll tell you one thing: they are coming! And they won't show any mercy. They're far worse than your darkest nightmares! And one day they'll get you. That day, you will envy… you will envy my gony!" The man violently vomits, then collapses on his side as he stops speaking and moving. His grimacing face still turned towards you makes you wonder if he's fully dead, but in absence of any response, you first think about leaving the ship as soon as possible before it explodes.]])
