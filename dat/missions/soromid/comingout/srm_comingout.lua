...
"See, I was running a few errands here in Soromid space, but I don't have my piloting license yet, so I hired someone else to give me a ride. Well, turns out I started finding out that I'm transgender at the worst possible time. I started changing my appearance ever so slightly and he suddenly started beïng a transmisic asshole to me, constantly goïng on about how I'll 'never be a real woman', calling me a "pervert", "sick", and pretty much every other shitty thing you can think of for weeks on end until he dumped me here on this bar yesterday. 'Just a few minutes,' he said. Well, clearly he isn't coming back. I was goïng to look for a new pilot after I picked a name, but you seem really nice. Could you be my transport? I would just need you to take me to a series of points in Soromid space. I can give you the same payment I was goïng to give to my previous transport, {credits}. Does that sound like something you'd be interested in doïng?"]])
...
dest_text = {}
dest_text[1] = _([[You arrive at your first destination with C after a relatively quiet, but pleasant trip. "Thank you for helping me with this," C says as you begin to approach. "And for treating me like a human beïng," they add with a mix of amusement and relief. You can't help but laugh slightly at the statement as you remark on how incredibly low the bar must be for you to be thanked for that. "I know, right? Well hey, the last guy didn't do that, so this is a nice change."

When you land, C takes off and goes to do whatever they need to do. By the time you've finished docking procedures, they return with a cheery look on their face. "Someone just called me 'ma'am'!" they explain excitedly. "That's the first time! It felt really validating. You know what? I'm goïng to start using she/her pronouns, I think." You give a nod and thank her for telling you.]])
