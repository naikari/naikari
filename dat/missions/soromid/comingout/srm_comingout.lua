...
local home_text = _([["It's so weird," Chelsea remarks as you begin landing procedures. "Coming out to you was easy, but coming out to my parents? Terrifying. I just hope they'll be accepting." When landing is finished and you and Chelsea step out onto the spaceport, she hands you the promised payment. "I hope we meet again some day, {player}. Come back here sometime; maybe I'll finally have my pilot license when you do!" You wish Chelsea good luck in coming out to her parents and in obtaining her pilot license as you part ways. Perhaps you should accept that invitation at some point in the future.]])

local misn_title = _("Coming Out")
local misn_desc = _([[You have been hired to transport someone who was stranded to several locations to run some errands:
...
function create()
   ...
   misn.setNPC(_("Quiet stranger"), "soromid/unique/chelsea.png",
         _("A stranger is sitting quietly at a table alone and staring off into space."))
end
