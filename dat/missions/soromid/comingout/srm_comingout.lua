...
"See, I was running a few errands for my parents here in Soromid space, but I don't have my piloting license yet, so I hired someone else to give me a ride. He said something about needing to get some 'personal things' sorted and that he would be back in just a few minutes. Well, it's been almost an hour now and he hasn't come back. I was going to look for a new pilot after sorting out my feelings about my gender for a bit, but you seem really nice. Could you be my transport? I would just need you to take me to a series of points in Soromid space. I haven't paid my previous transport yet, so I can give the payment to you instead. Does that sound like something you'd be interested in doing?"]])
...
dest_text[2] = _([[You have many long conversations with C about a number of topics during the trip to this location, including piloting. At some point during the trip, your experience as a pilot came up and you told C about your adventures. As you begin boarding, C speaks up again. "You know, you're an inspiration." You feel yourself blushing a little. She continues. "To travel all the way from Empire space into Soromid space really is quite huge! And all those places you've been to along the way! You're exactly the kind of pilot I want to be." You only half-jokingly suggest that maybe they should collaborate on a mission when she gets her piloting license. She softly giggles.
