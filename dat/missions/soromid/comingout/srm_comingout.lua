...
dest_text = {}
dest_text[1] = _([[You arrive at your first destination with C after a relatively quiët, but pleasant trip. "Thank you for helping me with this," C says as you begin to approach. "And for treating me like a human beïng," they add with a mix of amusement and relief. You can't help but laugh slightly at the statement as you remark on how incredibly low the bar must be for you to be thanked for that. "I know, right? Well hey, the last guy didn't do that, so this is a nice change."
