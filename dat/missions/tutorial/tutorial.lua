...
bar_text = _([["This is the Spaceport Bar, where you can read the latest news, but more importantly, you can meet civilians, hire pilots to join your fleet, and sometimes find unique mission opportunities! I recommend regularly talking to patrons at the bar, at least early on. Some may have useful tips for you!"]])
...
"When picking missions, pay attention to how much they pay. You'll want to strike a balance of choosing missions that you're capable of doing, but getting paid as much as possible to do them. Once you've accepted a mission, you can review it at any time via the Info window by pressing %s."]])
...
equipment_text = _([["This is the Equipment screen, available on all planets and stations with an outfitter or a shipyard. Here, you can equip your ships with outfits you own and sell outfits you have no more use for. If the planet or station you're landed at has a shipyard, you can also change which ship you're flying and sell unneeded ships. Selling a ship that still has outfits equipped will also lead to those outfits being sold along with the ship, so do keep that in mind.

"You will notice that your ship has already been equipped with two laser cannons, which we have provided for you free of charge since this is your first purchase. We hope they serve you well! If you make any changes to your ship now, please ensure that you still have two weapons equipped, as you will need those later for practicing combat and flying around space without any weapons can be very risky."]])
