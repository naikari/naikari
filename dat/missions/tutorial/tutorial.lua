...
"You will notice that your ship has already been equipped with two laser cannons, which we have provided for you free of charge since this is your first purchase. If you make any changes to your ship now, please ensure that you still have two weapons equipped, as you will need those later for practicing combat and flying around space without any weapons can be very risky."]])
