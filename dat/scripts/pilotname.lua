...
function pilotname.generic()
   ...
   local names = {
      ...
      p_("pilot_name", "Cloud {number}"),
      p_("pilot_name", "Club {number}"),
      ...
      p_("pilot_name", "Crossbow {number}"),
      p_("pilot_name", "Crow {number}"),
      p_("pilot_name", "Cutlass {number}"),
      ...
      p_("pilot_name", "Destroyer {number}"),
      ...
      p_("pilot_name", "Rhino {number}"),
      p_("pilot_name", "Rho {number}"),
      p_("pilot_name", "Rifle {number}"),
