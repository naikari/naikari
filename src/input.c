 ...
 * accel hacks
 */
static Uint64 input_accelLast = 0; /**< Used to see if double tap */
...
static Uint64 repeat_keyTimer = 0; /**< Repeat timer. */
...
static Uint64 input_mouseClickLast = 0; /**< Time of last click (in ms) */
