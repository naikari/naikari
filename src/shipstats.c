...
static const ShipStatsLookup ss_lookup[] = {
   ...
   I_ELEM(SS_TYPE_I_FORWARD_SALVO, fwd_salvo,
      N_("%+d Salvo Shots (Forward)"),
      N_("%+d Salvo Shots (Forward)")),
   D_ELEM(SS_TYPE_D_FORWARD_SALVO_MOD, fwd_salvo_mod,
      N_("%+G%% Salvo Shots (Forward)"),
      N_("%+.0f%% Salvo Shots (Forward)")),
   ...
   I_ELEM(SS_TYPE_I_TURRET_SALVO, tur_salvo,
      N_("%+d Salvo Shots (Turret)"),
      N_("%+d Salvo Shots (Turret)")),
   D_ELEM(SS_TYPE_D_TURRET_SALVO_MOD, tur_salvo_mod,
      N_("%+G%% Salvo Shots (Turret)"),
      N_("%+.0f%% Salvo Shots (Turret)")),
   ...
   I_ELEM(SS_TYPE_I_BOLT_SALVO, blt_salvo,
      N_("%+d Salvo Shots (Bolt)"),
      N_("%+d Salvo Shots (Bolt)")),
   D_ELEM(SS_TYPE_D_BOLT_SALVO_MOD, blt_salvo_mod,
      N_("%+G%% Salvo Shots (Bolt)"),
      N_("%+.0f%% Salvo Shots (Bolt)")),
   ...
   I_ELEM(SS_TYPE_I_LAUNCH_SALVO, launch_salvo,
      N_("%+d Salvo Shots (Launcher)"),
      N_("%+d Salvo Shots (Launcher)")),
   D_ELEM(SS_TYPE_D_LAUNCH_SALVO_MOD, launch_salvo_mod,
      N_("%+G%% Salvo Shots (Launcher)"),
      N_("%+.0f%% Salvo Shots (Launcher)")),
   ...
   AI_ELEM(SS_TYPE_A_SHIELD_REGEN_MALUS, shield_regen_malus,
      ...
      NULL,
      -INFINITY, INFINITY),
   P_ELEM(SS_TYPE_P_SHIELD_DYNAMO, shield_dynamo,
      N_("%+G pp Shield Dynamo"),
      N_("%.0f%% Shield Dynamo"),
      0., 1.),
   ...
   AI_ELEM(SS_TYPE_A_ARMOUR_REGEN_MALUS, armour_regen_malus,
      ...
      NULL,
      -INFINITY, INFINITY),
   P_ELEM(SS_TYPE_P_ARMOUR_DYNAMO, armour_dynamo,
      N_("%+G pp Armor Dynamo"),
      N_("%.0f%% Armor Dynamo"),
      0., 1.),
   ...
   P_ELEM(SS_TYPE_P_ABSORB, absorb,
      ...
      NULL,
      -INFINITY, INFINITY),
   P_ELEM(SS_TYPE_P_ABSORB_DYNAMO, absorb_dynamo,
      N_("%+G pp Absorb Dynamo"),
      N_("%.0f%% Absorb Dynamo"),
      0., 1.),
