...
static const ShipStatsLookup ss_lookup[] = {
   ...
   D_ELEM(SS_TYPE_D_FORWARD_SPEED, fwd_speed,
      N_("%+G%% Bullet Speed (Forward)"),
      N_("%+.0f%% Bullet Speed (Forward)")),
   ...
   P_ELEM(SS_TYPE_P_FORWARD_DAMAGE_AS_DISABLE, fwd_dam_as_dis,
      N_("%+G pp Damage to Disable Shift (Forward)"),
      N_("%.0f%% Damage to Disable Shift (Forward)")),
   P_ELEM(SS_TYPE_P_FORWARD_DISABLE_AS_DAMAGE, fwd_dis_as_dam,
      N_("%+G pp Disable to Damage Shift (Forward)"),
      N_("%.0f%% Disable to Damage Shift (Forward)")),
   P_ELEM(SS_TYPE_P_FORWARD_DAMAGE_SHIELD_AS_ARMOR, fwd_dam_shield_as_armor,
      N_("%+G pp Shield to Armor Damage Shift (Forward)"),
      N_("%.0f%% Shield to Armor Damage Shift (Forward)")),
   P_ELEM(SS_TYPE_P_FORWARD_DAMAGE_ARMOR_AS_SHIELD, fwd_dam_armor_as_shield,
      N_("%+G pp Armor to Shield Damage Shift (Forward)"),
      N_("%.0f%% Armor to Shield Damage Shift (Forward)")),
   ...
   D_ELEM(SS_TYPE_D_TURRET_SPEED, tur_speed,
      N_("%+G%% Bullet Speed (Turret)"),
      N_("%+.0f%% Bullet Speed (Turret)")),
   ...
   P_ELEM(SS_TYPE_P_TURRET_DAMAGE_AS_DISABLE, tur_dam_as_dis,
      N_("%+G pp Damage to Disable Shift (Turret)"),
      N_("%.0f%% Damage to Disable Shift (Turret)")),
   P_ELEM(SS_TYPE_P_TURRET_DISABLE_AS_DAMAGE, tur_dis_as_dam,
      N_("%+G pp Disable to Damage Shift (Turret)"),
      N_("%.0f%% Disable to Damage Shift (Turret)")),
   P_ELEM(SS_TYPE_P_TURRET_DAMAGE_SHIELD_AS_ARMOR, tur_dam_shield_as_armor,
      N_("%+G pp Shield to Armor Damage Shift (Turret)"),
      N_("%.0f%% Shield to Armor Damage Shift (Turret)")),
   P_ELEM(SS_TYPE_P_TURRET_DAMAGE_ARMOR_AS_SHIELD, tur_dam_armor_as_shield,
      N_("%+G pp Armor to Shield Damage Shift (Turret)"),
      N_("%.0f%% Armor to Shield Damage Shift (Turret)")),
   ...
   P_ELEM(SS_TYPE_P_LAUNCH_DAMAGE_AS_DISABLE, launch_dam_as_dis,
      N_("%+G pp Damage to Disable Shift (Launcher)"),
      N_("%.0f%% Damage to Disable Shift (Launcher)")),
   P_ELEM(SS_TYPE_P_LAUNCH_DISABLE_AS_DAMAGE, launch_dis_as_dam,
      N_("%+G pp Disable to Damage Shift (Launcher)"),
      N_("%.0f%% Disable to Damage Shift (Launcher)")),
   P_ELEM(SS_TYPE_P_LAUNCH_DAMAGE_SHIELD_AS_ARMOR, launch_dam_shield_as_armor,
      N_("%+G pp Shield to Armor Damage Shift (Launcher)"),
      N_("%.0f%% Shield to Armor Damage Shift (Launcher)")),
   P_ELEM(SS_TYPE_P_LAUNCH_DAMAGE_ARMOR_AS_SHIELD, launch_dam_armor_as_shield,
      N_("%+G pp Armor to Shield Damage Shift (Launcher)"),
      N_("%.0f%% Armor to Shield Damage Shift (Launcher)")),
